		...
		public static partial class Resources
		{
			...
			public static partial class OuterEllipse
			{
				public static partial class Fill
				{
					...
					public static ThemeResourceKey<Brush> Normal => new("RadioButtonOuterEllipseFill");
				...
				public static partial class Stroke
				{
					...
					public static ThemeResourceKey<Brush> Normal => new("RadioButtonOuterEllipseStroke");
			...
			public static partial class OuterEllipseCheckedFill
			{
				[ResourceKeyDefinition(typeof(Brush), "RadioButtonOuterEllipseCheckedFill")]
				public static ThemeResourceKey<Brush> Normal => new("RadioButtonOuterEllipseCheckedFill");

				[ResourceKeyDefinition(typeof(Brush), "RadioButtonOuterEllipseCheckedFillPointerOver")]
				public static ThemeResourceKey<Brush> PointerOver => new("RadioButtonOuterEllipseCheckedFillPointerOver");

				[ResourceKeyDefinition(typeof(Brush), "RadioButtonOuterEllipseCheckedFillPressed")]
				public static ThemeResourceKey<Brush> Pressed => new("RadioButtonOuterEllipseCheckedFillPressed");

				[ResourceKeyDefinition(typeof(Brush), "RadioButtonOuterEllipseCheckedFillDisabled")]
				public static ThemeResourceKey<Brush> Disabled => new("RadioButtonOuterEllipseCheckedFillDisabled");
			}

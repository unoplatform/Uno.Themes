...
public static partial class Theme
{
	public static partial class Slider
	{
		public static partial class Resources
		{
			public static partial class Default
			{
				public static partial class Thumb
				{
					...
					[ResourceKeyDefinition(typeof(CornerRadius), "SliderThumbCornerRadius")]
					public static ThemeResourceKey<CornerRadius> CornerRadius => new("SliderThumbCornerRadius");
				}
		...
		{
			[ResourceKeyDefinition(typeof(Style), "SliderStyle", TargetType = typeof(global::Microsoft.UI.Xaml.Controls.Slider))]

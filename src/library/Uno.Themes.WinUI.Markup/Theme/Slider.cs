			...
			public static partial class Resources
			{
				...
				public static partial class TickBar
				{
					...
					public partial class FillVSG
					{
						...
						public ThemeResourceKey<Brush> Default = new("SliderTickBarFill");

						[ResourceKeyDefinition(typeof(Brush), "SliderTickBarFillDisabled")]
						public ThemeResourceKey<Brush> Disabled = new("SliderTickBarFillDisabled");
				...
				public static partial class Track
				{
					...
					public partial class FillVSG
					{
						...
						public ThemeResourceKey<Brush> Default = new("SliderTrackFill");

						[ResourceKeyDefinition(typeof(Brush), "SliderTrackFillDisabled")]
						public ThemeResourceKey<Brush> Disabled = new("SliderTrackFillDisabled");

						public static implicit operator ThemeResourceKey<Brush>(FillVSG self) => self.Default;
					}

					public static readonly ValueFillVSG ValueFill = new();
					public partial class ValueFillVSG
					{
						[ResourceKeyDefinition(typeof(Brush), "SliderTrackValueFill")]
						public ThemeResourceKey<Brush> Default = new("SliderTrackValueFill");

						[ResourceKeyDefinition(typeof(Brush), "SliderTrackValueFillDisabled")]
						public ThemeResourceKey<Brush> Disabled = new("SliderTrackValueFillDisabled");

						public static implicit operator ThemeResourceKey<Brush>(ValueFillVSG self) => self.Default;
					}

...
{
	public static Shell GetForCurrentView() => (Shell)NavigationHelper.MainWindow.Content;
	...
	private void SetDarkLightToggleInitialState()
	{
		...
		var root = NavigationHelper.MainWindow.Content as FrameworkElement;
	...
	private void ToggleButton_Click(object sender, RoutedEventArgs e)
	{
		...
		if (NavigationHelper.MainWindow.Content is FrameworkElement root)
		{
			switch (root.ActualTheme)
			{
				case ElementTheme.Default:

...
public partial class SamplePageLayout : ContentControl
{
	...
	private const string VisualStateOmarchy = nameof(Design.Omarchy);
	...
	private IReadOnlyCollection<LayoutModeMapping> LayoutModeMappings => new List<LayoutModeMapping>
	{
		...
		new LayoutModeMapping(Design.Omarchy, _materialRadioButton, _stickyMaterialRadioButton, VisualStateOmarchy, /* templates: */ OmarchyTemplate),
	};

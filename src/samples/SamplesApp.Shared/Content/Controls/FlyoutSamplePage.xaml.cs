...
[SamplePage(SampleCategory.Controls, "Flyout", IconPath = Icons.Controls.Flyout, Description = "A flyout is a UI container that can be light dismissed. It can contain other flyouts or context menus to create a nested experience.", DocumentationLink = "https://docs.microsoft.com/en-us/windows/uwp/design/controls-and-patterns/dialogs-and-flyouts/flyouts", SupportedDesigns = new[] { Design.Material, Design.Cupertino, Design.Simple })]

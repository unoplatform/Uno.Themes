...
The values below describe Material v2 typography. Design systems share the slot
names but can use different sizes and weights; see [Semantic Typography](../semantic-styles.md#typography).

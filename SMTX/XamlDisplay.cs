...
namespace ShowMeTheXAML
{
	public partial class XamlDisplay : ContentControl
	{
		...
		public static new readonly DependencyProperty DefaultStyleKeyProperty = DependencyProperty.Register(
		nameof(DefaultStyleKey),
		typeof(Style),
		typeof(XamlDisplay),
		new PropertyMetadata(typeof(XamlDisplay)));

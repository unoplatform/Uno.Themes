...
# Builds the four theme sample heads for browserwasm so ThemesSampleApp can package their
...
for head in MaterialSampleApp CupertinoSampleApp SimpleSampleApp FluentSampleApp; do

...
# Builds the theme sample heads for browserwasm so ThemesSampleApp can package their
...
for head in MaterialSampleApp CupertinoSampleApp SimpleSampleApp OmarchySampleApp; do
